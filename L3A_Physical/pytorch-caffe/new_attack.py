...
class attack_msf():
    def __init__(self, args):
        ...
        self.num_pos = 1
        self.threshold = 0.4
        self.root_path = '/home/autocars/Desktop/MSF-ADV-master/data/'
        self.pclpath = 'pcd/'
    ...
    def rendering_img(self, ppath):
        ...
        render.savemesh(self.args.object, self.args.object_save + pp + '_v2.ply', vertice, face, r=1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-obj', '--obj', dest='object', default="./object/object2.ply")
    ...
    parser.add_argument('-o', '--opt', dest='opt', default="pgd")  # pgd
